...
void RGBController_Network::SetDeviceProfile(size_t profile)
{
    unsigned char * data = GetProfileDescription(profile);

    client->SendRequest_RGBController_SetDeviceProfile(dev_idx, data, sizeof(profile));
