...
|   5:      Zone flags, controller flags, resizable effects-only zones (Release 1.0)        |
|   6:      Add device profiles support (Release 1.1)                                       |
\*-----------------------------------------------------------------------------------------*/
...
enum
{
    ...
    NET_PACKET_ID_RGBCONTROLLER_SETDEVICEPROFILE = 1200,/* RGBController::SetProfile()                          */
};
